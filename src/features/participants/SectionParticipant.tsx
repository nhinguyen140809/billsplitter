...
function SectionParticipant({ onDone, status }: { onDone: () => void; status: SectionStatus }) {
  ...
  return (
    <Section title="Participants">
      ...
      <ParticipantList members={members} onRemove={handleRemoveMember} isLocked={isLocked} />

      {!isLocked && (
        <div className="mt-8 flex items-center justify-end">
          <Button onClick={handleDone} variant="default" size="default">
