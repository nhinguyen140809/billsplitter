...
function BillNameInput() {
    ...
    return (
        <input
            ...
            className="w-full pb-1 sm:pb-2 p-2 font-bold text-lg sm:text-xl text-card-foreground outline-none border-b-2 focus:border-b-primary mb-3 sm:mb-4 transition duration-200 border-b-accent"
            value={formData.name}
